...
def build_features(df: pd.DataFrame, target_col: str = "casetype") -> pd.DataFrame:
    """
    ...
    numeric_cols = [c for c in df.select_dtypes(include=["int64", "float64"]).columns if c != target_col]
